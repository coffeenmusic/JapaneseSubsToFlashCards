...
parser.add_argument('-s', '--sub', type=str, required=True, help='Subtitle path. Required')
...
deck_name = args.deck_name if args.deck_name != None else ntpath.basename(sub_file).split('.')[0]
